...
export default function ItemCarrousel({ item }) {
    ...
    return (
        ...
        <Card sx={{ width: 160, height: 200, backgroundImage: `url("${img}")`, backgroundSize:"160px 200px"  }}>
            <>
                {/* <CardMedia
                    component="img"
                    height="75"
                ...
                <CardContent sx={{ position: "absolute", bottom: "5px", margin: "5px", padding:"0", backgroundColor:"#7c756c6b", width:"155px" }} >
                    ...
                    <Tooltip title="Alcanzaste el limite de stock" disableHoverListener={stockLimit() !== 0} followCursor>
                        <span>
                            <IconButton
                                ...
                                onClick={onAdd}
                            >
                                <AddShoppingCartIcon sx={{ paddingTop: "2px", color: "white" }} />
                                <Snackbar
