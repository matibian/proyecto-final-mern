        ...
        <Grid item sx={{ display: { xs: 'none', sm: 'block' } }} sm={1}>
          <div style={{ textAlign: "end", paddingRight: "10vh"}}>
            ...
            <ul style={{ listStyleType: "none" }}>
              <li onClick={() => navigate(`category/Componentes`)} style={{cursor: "pointer"}}>Componentes</li>
              <li onClick={() => navigate(`category/Almacenamiento`)} style={{cursor: "pointer"}}>Almacenamiento</li>
              <li onClick={() => navigate(`category/Perifericos`)} style={{cursor: "pointer"}}>Periféricos</li>
              <li onClick={() => navigate(`category/Tablets`)} style={{cursor: "pointer"}}>Tablets</li>
            </ul>
          </div>
        </Grid>
