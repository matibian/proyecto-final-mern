                    ...
                    <div className="p-5">
                      ...
                      <div className="pt-5">
                        <MDBTypography tag="h6" className="mb-0">
                          ...
                          >
                            <MDBIcon fas icon="long-arrow-alt-left me-2" /> Ir a
                            productos
                          </MDBCardText>
                        </MDBTypography>
                      </div>
                    ...
                    <div className="p-5">
                      ...
                      <div className="mb-4 pb-2">
                        <select
                          ...
                          onChange={(choice) =>
                            delivery(Number(choice.target.value))
                          }
                          style={{ width: "100%" }}
                        >
                          <option value="0">GBA - Gratis</option>
                          <option value="1000">
                            Provincia de Buenos Aires - $1000
                          </option>
                          <option value="2000">
                            Santa Fé, La Pampa, Cordoba - $2000{" "}
                          </option>
                          <option value="3000">
                            Resto de Argentina - $3000
                          </option>
                        </select>
                      </div>
                      <MDBTypography tag="h5" className="text-uppercase mb-3">
                          ...
                          >
                            {discount ? (
                              <>
                                ...
                                <br />$
                                {(cartTotal() * 0.9 + envio).toLocaleString(
                                  "de-DE"
                                )}{" "}
                                total
                              </>
